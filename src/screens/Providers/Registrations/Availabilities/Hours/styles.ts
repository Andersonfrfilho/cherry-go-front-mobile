...
import { DaySelected, HoursSelected } from '.';
...
export const List = styled(FlatList as new () => FlatList<HoursSelected>)``;
...
export const AreaHour = styled.TouchableOpacity<AreaInfoProps>`
  flex: 1;
  border-radius: 8px;
  height: 40px;
  margin: 3px;
  ...
  align-items: center;
`;
export const HourTitle = styled.Text<AreaInfoDateProps>`
  font-size: ${({ size }) => RFValue(size || 16)}px;
  color: ${({ theme }) => theme.colors.shape};
  text-align: center;
`;

export const AreaSelectedTimeRange = styled.View`
  flex-direction: row;
  height: 60px;
  margin-top: 5px;
  margin-bottom: 5px;
`;
export const AreaSelectedTimeStart = styled.View`
  flex: 2.5;
`;
export const Selected = styled.View``;
export const AreaSelectedTimeEnd = styled.View`
  flex: 2.5;
  margin-left: 3px;
`;
export const AreaSendHourAvailable = styled.TouchableOpacity`
  flex: 1;
...
export const AreaAlreadyTimeRange = styled.View`
  flex-direction: row;
  height: 60px;
  background-color: ${({ theme }) => theme.colors.header};
  margin-top: 5px;
...
export const AreaViewTimeStart = styled.View`
  flex: 2;
  justify-content: center;
  align-items: center;
`;
export const AreaViewTimeEnd = styled.View`
  flex: 2;
  justify-content: center;
  align-items: center;
`;
export const AreaViewRange = styled.View`
  flex: 1;
  justify-content: center;
  align-items: center;
`;
export const AreaExcludeTime = styled.TouchableOpacity`
  flex: 1;
